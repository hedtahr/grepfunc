...
var Tool = server.Tool{
	...
	InputSchema: server.InputSchema{
		...
		Properties: map[string]server.Property{
			"path":              {Type: "string", Description: "Path to the file to edit. Relative to project root (e.g. 'src/main.go') or absolute. Project root directory name prefix also accepted."},
			...
			"undo":              {Type: "boolean", Description: "If true, restore the file from the backup saved before the last edit. Ignores all other params."},
